...
<template>
    <Transition name="fade">
        <div v-if="isOpen" class="fixed top-[-32px] inset-0 z-50 flex min-h-screen items-start sm:items-center justify-center px-4 py-10 sm:p-4 bg-slate-900/50 backdrop-blur-sm overflow-y-auto">
